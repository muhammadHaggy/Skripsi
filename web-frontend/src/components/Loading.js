const Loading = ({
    ...
    return (
        <div className={` ${visibility ? 'flex' : 'hidden'} justify-center items-center z-50 absolute top-0 left-0 right-0 bottom-0`}>
            <div className={`fixed flex flex-col items-center`}>
                ...
                {message && (
                    <p className="mt-4 text-white text-lg font-semibold bg-black bg-opacity-50 px-4 py-2 rounded-lg">
                        {message}
                    </p>
                )}
            </div>
